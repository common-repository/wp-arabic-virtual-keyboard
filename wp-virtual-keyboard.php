...
function wpavk_plugin_admin_add_page() {
	add_menu_page('WP Arabic Virtual Keyboard', 'Arabic Keyboard', 'manage_options', 'wpavk_admin', 'wpavk_admin',plugins_url('/images/keyboard-icon.png', __FILE__));
}
...
function wpavk_keyboard_script() {
	wp_enqueue_script( 'wp-arabic-keyboard-clipboard', plugin_dir_url( __FILE__ ) . 'js/clipboard.min.js', array(), '0.1', 'screen' );
	wp_enqueue_script( 'wp-arabic-keyboard-script', plugin_dir_url( __FILE__ ) . 'js/script.js', array(), '1.1.1', 'screen' );
}    
...
function wpavk_keyboard_shortcode($atts) { 
	...
	<li><a class=\'key c20 alt\' id=\'caps\' data-clipboard-target=\'#area\'><span>Copy</span></a></li>
